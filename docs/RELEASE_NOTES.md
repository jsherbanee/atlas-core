...
- Projects library pages now use the shared Universal Workspace Framework for page headers, metrics, selected-record inspectors, and maintenance controls while keeping repository-backed open/create/import flows intact.
...
- full gates passing: `black --check .`, `ruff check .`, `mypy .`, `pytest`
- full-suite validation: `1499 passed`
...
- no standalone Change Order document family
